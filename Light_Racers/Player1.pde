...
Date: 10 April 2018
Program: Light Racer: Player 1
Program Description: This class implements the abstacted racer class to create racer for the user to control. The class includes drawing and updating the racer, and changing the racer's direction based on user key-input.  
*/
